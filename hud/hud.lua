...
local directIni = "moonloader\\config\\hud.ini"
local font = renderCreateFont("TT Norms Regular", 20, 0)
...
local update_url = "https://raw.githubusercontent.com/FraiserTEST/scripts/main/hud/hud.ini" -- тут тоже свою ссылку
local update_path = getWorkingDirectory() .. "/hud.ini" -- и тут свою ссылку

local script_url = "https://github.com/FraiserTEST/scripts/blob/main/hud/hud.lua" -- тут свою ссылку
...
function main()
  ...
  renderFontDrawText(font, money, x - renderGetFontDrawTextLength(font, money) / 2, y, 0xFFFFFFFF)
   renderFontDrawText(font, "{A3FF00}$", x - renderGetFontDrawTextLength(font, money) / 2 - 18, y, 0xFFFFFFFF)
